...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HotDrinks = __webpack_require__(165);

	var _HotDrinks2 = _interopRequireDefault(_HotDrinks);

	var _ColdDrinks = __webpack_require__(166);

	var _ColdDrinks2 = _interopRequireDefault(_ColdDrinks);

	var _Tea = __webpack_require__(167);

	var _Tea2 = _interopRequireDefault(_Tea);

	var _Bakery = __webpack_require__(168);

	var _Bakery2 = _interopRequireDefault(_Bakery);

	var _SpecialInstructions = __webpack_require__(169);

	var _SpecialInstructions2 = _interopRequireDefault(_SpecialInstructions);

	var _OrderTotal = __webpack_require__(170);

	var _OrderTotal2 = _interopRequireDefault(_OrderTotal);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var HOTDRINKS = [{ name: "Latte" }, { name: "Americano" }, { name: "Cappucino" }, { name: "Espresso" }, { name: "Macchiato" }];

	var COLDDRINKS = [{ name: "Iced Latte" }, { name: "Iced Mocha" }, { name: "Iced Chai" }, { name: "Iced Coffee" }, { name: "Frappe" }];

	var TEA = [{ name: "Green" }, { name: "Jasmine Green" }, { name: "Chai" }, { name: "Mint" }, { name: "Chamomile" }];

	var BAKERY = [{ name: "Croissant" }, { name: "Banana Muffin" }, { name: "Blueberry Scone" }, { name: "Carrot Cake" }, { name: "Home-Made Cookies" }];
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'form',
	                null,
	                _react2.default.createElement(_HotDrinks2.default, { drinks: HOTDRINKS }),
	                _react2.default.createElement(_ColdDrinks2.default, { drinks: COLDDRINKS }),
	                _react2.default.createElement(_Tea2.default, { drinks: TEA }),
	                _react2.default.createElement(_Bakery2.default, { items: BAKERY }),
	                _react2.default.createElement(_SpecialInstructions2.default, null),
	                _react2.default.createElement(_OrderTotal2.default, null)
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HotDrinkItem = _react2.default.createClass({
	    displayName: "HotDrinkItem",
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                "select",
	                { name: "milk-type", defaultValue: "Milk Type" },
	                _react2.default.createElement(
	                    "option",
	...
	var HotDrinks = _react2.default.createClass({
	    displayName: "HotDrinks",

	    render: function render() {
	        var drinkItems = this.props.drinks.map(function (arrayItem, index) {
	            return _react2.default.createElement(HotDrinkItem, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColdDrinkItem = _react2.default.createClass({
	    displayName: "ColdDrinkItem",
	...
	var ColdDrinks = _react2.default.createClass({
	    displayName: "ColdDrinks",

	    render: function render() {
	        var drinkItems = this.props.drinks.map(function (arrayItem, index) {
	            return _react2.default.createElement(ColdDrinkItem, {
	                drinkName: arrayItem.name,
	                key: index });
	        }, this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeaItem = _react2.default.createClass({
	    displayName: "TeaItem",
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                "select",
	                { name: "size", defaultValue: "Size" },
	                _react2.default.createElement(
	                    "option",
	                    { value: "Size", disabled: true },
	                    "Size"
	                ),
	                _react2.default.createElement(
	                    "option",
	...
	var Tea = _react2.default.createClass({
	    displayName: "Tea",

	    render: function render() {
	        var teaItems = this.props.drinks.map(function (arrayItem, index) {
	            return _react2.default.createElement(TeaItem, {
	                drinkName: arrayItem.name,
	                key: index });
	        }, this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BakeryItem = _react2.default.createClass({
	    displayName: "BakeryItem",
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                "select",
	                { name: "quantity", defaultValue: "Qty" },
	                _react2.default.createElement(
	                    "option",
	                    { value: "Qty", disabled: true },
	                    "Qty"
	                ),
	                _react2.default.createElement(
	                    "option",
	...
	var Bakery = _react2.default.createClass({
	    displayName: "Bakery",

	    render: function render() {
	        var bakeryItems = this.props.items.map(function (arrayItem, index) {
	            return _react2.default.createElement(BakeryItem, {
	                name: arrayItem.name,
	                key: index });
	        }, this);
